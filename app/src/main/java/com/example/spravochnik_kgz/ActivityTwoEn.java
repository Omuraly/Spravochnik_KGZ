...
public class ActivityTwoEn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_en);
        ...
        // получаем курсор
        cursor = db.getSepficItemEn(letters[clickLetter]);
        ...
        spisok = (ListView) findViewById(R.id.lvCityeng);
        ...
        spisok.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(ActivityTwoEn.this, DetailActivityEn.class);
